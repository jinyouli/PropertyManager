...
-(void)createSubviews{
    ...
    self.titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(75, 15, ScreenWidth - 95, 20)];
    self.titleLabel.textColor = mainTextColor;
    [self.backView addSubview:self.titleLabel];
    
    self.timeLabel = [[UILabel alloc]initWithFrame:CGRectMake(75, 35, ScreenWidth - 95, 15)];
    self.timeLabel.textColor = lineColor;
    self.timeLabel.font = SmallFont;
    [self.backView addSubview:self.timeLabel];
    
    
    self.contentLabel = [[UILabel alloc]initWithFrame:CGRectMake(20, 75, contenSize.width, contenSize.height)];
