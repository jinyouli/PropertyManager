...
- (void)viewDidLoad {
    ...
    self.imageArr = @[@"MySetting",@"MyAbout",@"MyShare",@"login_out"];
...
-(void)createSubviews{
    ...
    ZYButton * iconBtn = [[ZYButton alloc] initWithTitle:[PMTools subStringFromString:user.worker_name isFrom:YES] font:LargeFont color:[UIColor whiteColor] selectColor:nil];
