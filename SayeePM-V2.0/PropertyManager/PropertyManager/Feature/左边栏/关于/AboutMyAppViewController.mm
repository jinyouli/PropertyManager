...
//    imageView.backgroundColor = mainColor;
    ...
    [lookVesionBtn setTitle:@"查看条款和隐私政策" forState:UIControlStateNormal];
    ...
    NSArray * titleArr = @[@"All Rights Reserved",@"Copyright © 2016 Sayee, Co.,Ltd.",@"赛翼智能 版权所有"];
...
-(void)lookVesionBtnClick{
    SYLog(@"查看条款和隐私政策");
    [[Routable sharedRouter] open:CLAUSE_VIEWCONTROLLER animated:YES extraParams:@{@"myTitle":@"使用条款和隐私政策"}];
}
